...
compiler::Item_func_call::Item_func_call(const uint32_t& line_no,
                                         Item_ident* const identifier,
                                         Item_func_call_list* const arguments)
    : Item_expr(line_no), identifier(identifier), arguments(arguments) {}

compiler::Item_func_def_arg::Item_func_def_arg(const uint32_t& line_no,
                                               const basic_type& type,
                                               Item_ident* const identifier)
    : Item_expr(line_no), type(type), identifier(identifier) {}
